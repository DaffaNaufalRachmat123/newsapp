package com.android.nostranews.common.widget
...
import com.android.nostranews.common.R
...
class LoadingDots : LinearLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        mDotsColor = a.getColor(R.styleable.LoadingDots_LoadingDots_dots_color, context.resources.getColor(R.color.teal_200))
